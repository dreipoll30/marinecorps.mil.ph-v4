...
import { frequentQuestions } from './data/join/disclosure';
...
export function DisclosureItem({ children, className }: { children: ReactNode, className?: string }) {
    return (
        <div className={`flex flex-col w-full border-b border-gray-300 overflow-hidden last:border-b-0 ${className}`}>{children}</div>
    )
}
