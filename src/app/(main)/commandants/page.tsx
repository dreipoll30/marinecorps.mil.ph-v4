...
export default function Commandants() {
    return (
        <>
            <NavigationBar />
            <HeaderInside>
                ...
                <ContentWrapper>
                    <Section>
                        <SectionHeadingWrapper>
                            <SectionHeading title="Lineage of Commandants" className="mb-0" />
                            <Breadcrumbs>
                                <BreadcrumbsItem href="/">Home</BreadcrumbsItem>
                                <BreadcrumbsItem href="/">Lineage of Commandants</BreadcrumbsItem>
                            </Breadcrumbs>
                        </SectionHeadingWrapper>
                    </Section>
                    <Section>
                        <Section>
                            <Profile>
                                {lineageCommandants.map((commandant) => (
